# Based on Blockscout v11.3.0, commit 43af7ea84797e2f3a55ac1191d9cbe67436eb3e8.
FROM docker.io/hexpm/elixir:1.19.4-erlang-27.3.4.6-alpine-3.22.2@sha256:c129490fa75f7d00a28e293eb8ee5e00d1b7b34da03748b998369e41ef8a0a1e AS builder-deps
...
RUN MIX_OS_DEPS_COMPILE_PARTITION_COUNT=$(nproc) mix do deps.get + local.rebar --force + deps.compile --skip-umbrella-children
...
##############################################################
FROM docker.io/hexpm/elixir:1.19.4-erlang-27.3.4.6-alpine-3.22.2@sha256:c129490fa75f7d00a28e293eb8ee5e00d1b7b34da03748b998369e41ef8a0a1e
