...
| **ProxyAdmin** | `Contracts/Genesis/proxy/transparent/ProxyAdmin.sol` | No | `0x...FacAdE` (genesis) |
...
| **Self-hosted (GasSponsor)** | On-chain treasury at `Contracts/7702/GasSponsor.sol`. Sponsors deposit CRYFT, relayers claim reimbursement. | Independent sponsorship without thirdweb dependency |
...
**Source:** `Contracts/7702/GasSponsor.sol`
