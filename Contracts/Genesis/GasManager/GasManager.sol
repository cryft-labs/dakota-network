...
/*
 ...
 \___/\_,_/___//_/  /_/\_,_/_//_/\_,_/\_, /\_ /_/
  ...
  │                                                      │
  │  Direct funds use .call; sponsor funds use depositGasCredit│
...
contract GasManager is Initializable, ReentrancyGuardUpgradeable {
    ...
    modifier afterPrimaryInitialization() {
        require(_getInitializedVersion() == 1, "Primary initialization required");
        _;
    }

    function initializeV2() public afterPrimaryInitialization onlyVoters reinitializer(2) {
    ...
    function executeSponsorFunding(bytes32 fundKey) public nonReentrant {
        ...
        IGasSponsorDepository(_GAS_SPONSOR).depositGasCredit{value: proposal.amount}(
            sponsor
        );
